...
<head>
    ...
    <link rel="stylesheet" href="assets/css/eventOrganizerRegister.css">
    <title>Amerta | Event Organizer Register</title>
</head>
<body>
        ...
        <div class="fill container-fluid">
            <form class="row" method="POST" action="">
                ...
                <div class="loginText text-center mb-3">
                    Have an account?
                    <a href="eventOrganizerLogin.php" class="loginBtn"> Login </a>
                </div>
            </form>
        </div>
    </section>
